...
When connected to an iPhone Duo instance, the component shows both native displays
in a folding frame. Position starts locked, so screen gestures control iOS. Unlock
