...
2D view with fold/unfold, rotation and hardware controls. Select **3D** to load the
...
In 3D, position starts locked, so screen gestures control iOS. Unlock
position to rotate the view. The device's Sleep/Wake and volume buttons support
