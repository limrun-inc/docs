...
pose, and position starts locked so screen gestures control iOS. Unlock position
to rotate the 3D view. In both modes, the device's Sleep/Wake and volume buttons support
