 ...
 *  - undefined:             defaults to 'ForegroundIfRunning', i.e. the app is launched
 */
```
...
| `launchMode` | `'ForegroundIfRunning' \| 'RelaunchIfRunning'` | Launch behavior post-install. Defaults to `ForegroundIfRunning`, i.e. the app is launched. |
