...
Universal Logout is configured by default so if you revoke all sessions
in Okta, Okta will trigger token revocation for all users of the Limrun organization.
