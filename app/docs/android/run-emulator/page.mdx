...
A successful `create` returns the full instance resource. URLs are truncated for legibility but the field set is exactly what comes off the wire.

```json
{
  "metadata": {
    "id": "android_euna_01krx34kfre3m99md4p7hnb7y0",
    "createdAt": "2026-05-18T08:27:15Z",
  ...
  "status": {
    "state": "ready",
    "apiUrl":               "https://eu-north1-29-...limrun.net/v1/android_euna_01krx34kfre3m99md4p7hnb7y0",
    "adbWebSocketUrl":      "wss://eu-north1-29-...limrun.net/v1/android_euna_01krx34kfre3m99md4p7hnb7y0/adb",
    "endpointWebSocketUrl": "wss://eu-north1-29-...limrun.net/v1/android_euna_01krx34kfre3m99md4p7hnb7y0/ws",
    "signedStreamUrl":      "https://console.limrun.com/embed?id=android_euna_01krx34kfre3m99md4p7hnb7y0&token=...",
    "mcpUrl":               "https://eu-north1-29-...limrun.net/v1/android_euna_01krx34kfre3m99md4p7hnb7y0/mcp",
    "targetHttpPortUrlPrefix": "https://eu-north1-29-...limrun.net/v1/android_euna_01krx34kfre3m99md4p7hnb7y0/proxy/",
    "token": "..."
  }
}
```
...
| `status.targetHttpPortUrlPrefix` | Reverse-proxy prefix for tunneled HTTP ports running on the device. |
...
`quality` accepts the integers `5` through `10`. Higher values increase bitrate and file size. A 3-second clip at `5` lands around 230 KB; at `10` it's a few megabytes.
