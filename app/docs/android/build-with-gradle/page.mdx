...
Where phase billing is enabled, a metered Gradle sandbox charges active work
and idle time at different rates. The standard rate is 1 credits per minute
for active work and 0.25 credits per minute while idle. Negotiated account
...
Gradle retains its wall-clock rate of 0.5 credits per minute. Simulators
