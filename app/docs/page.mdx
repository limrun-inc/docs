...
The iOS simulator and Xcode sandbox are separate instances that attach to each other: build in the sandbox, then attach a simulator to it. A successful build auto-installs on the attached simulator, which is the most common shape.
