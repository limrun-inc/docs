...
- Asking for a major the node does not have fails with the installed list. Only majors are selectable; the minor is whatever the fleet carries for that major.
