...
description: "Drive a running iOS simulator from code or shell: taps, typing, screenshots, recordings, camera simulation, app lifecycle, keychain state, logs, and reverse tunnels."
order: 3
icon: "smartphone"
---
