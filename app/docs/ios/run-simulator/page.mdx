...
Sandboxed simulator processes cannot directly read or write the host Mac's `/Library/Preferences/com.apple.networkextension.plist` or `com.apple.networkextension.uuidcache.plist`, including through `/System/Volumes/Data`. Store app data and preferences in the app's own container.
