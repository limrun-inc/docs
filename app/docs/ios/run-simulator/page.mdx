...
### Fixed-port reverse tunnel

`lim ios reverse` remains available for workflows that already choose a simulator-facing port in the reserved range. The direction is simulator to your service.
