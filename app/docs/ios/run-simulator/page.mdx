...
rotation controls, and touch input on its cover and inner display. Click or hold
the frame's Sleep/Wake and volume buttons to control iOS. **Position locked**
prevents camera rotation while keeping the screen and hardware buttons active.
