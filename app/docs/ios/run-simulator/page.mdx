...
lim ios scroll up --amount 300 --momentum 0.4
```
...
```bash
lim ios camera-video play ./fixtures/qr-scan.mp4
lim ios camera-video play ./fixtures/intro.mp4 --no-loop
lim ios camera-video clear
```
