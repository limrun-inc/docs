...
<Steps>
  ...
  <Step title="Fill in the environment">
    ...
    <Frame>
      <img src="/images/claude-code-web/02-environment.png" width="360" alt="Add cloud environment dialog filled in with the name limrun, Full network access, LIM_API_KEY with a placeholder value, and the setup script" />
    </Frame>
