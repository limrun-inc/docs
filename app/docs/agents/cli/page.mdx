...
| `--upload-ttl <duration>` | Expiry of the uploaded asset as a Go duration (e.g. `720h`). Defaults to 14 days for newly created assets; re-uploads keep the current expiry. Requires `--upload`. |
