...
The CLI sends privacy-safe product events such as skill installation, authentication, and command intent. It does not send command arguments, API keys, hostnames, project paths, repository names, logs, or raw errors. To disable this telemetry:
