...
Declaring `localhost:8000` makes literal simulator `localhost:8000` reach the agent machine's `localhost:8000`. Other hostnames are not supported in this release.
