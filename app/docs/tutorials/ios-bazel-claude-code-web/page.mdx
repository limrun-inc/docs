...
- A Claude Code on the web environment set up as described in [Claude Code on the web](/docs/agents/claude-code-web). This tutorial calls it `limrun`.
...
<Steps>
  <Step title="Create your copy of the template">
    ...
    <Frame>
      <img src="/images/claude-code-web/06-use-template.png" alt="The ios-bazel-template repository page with the Use this template menu open, showing Create a new repository" />
    </Frame>
  </Step>
  ...
  <Step title="Add bazelisk to the setup script">
    ...
    <Frame>
      <img src="/images/claude-code-web/04b-setup-script-bazel.png" alt="Setup script field with npm install --global lim @bazel/bazelisk and the lim skills install line" />
    </Frame>
  </Step>
  ...
  <Step title="Build and run the app">
    ...
    <Frame>
      <img src="/images/claude-code-web/07-build.png" alt="Session output of bazelisk --digest_function=sha256 build --config=limrun //App finishing with 35 remote processes and Build completed successfully" />
    </Frame>
    ...
    <Frame>
      <img src="/images/claude-code-web/08-stream-link.png" alt="Claude's reply with a screenshot of the chat app on the simulator, a Live simulator link, and a summary of the build" />
    </Frame>

    Open the link to use the app in your browser:

    <Frame>
      <img src="/images/claude-code-web/09-simulator.png" alt="The live simulator in the browser running the chat app, with live events, app logs, and network request panels" />
    </Frame>
  </Step>
  ...
  <Step title="Change the app">
    ...
    <Frame>
      <img src="/images/claude-code-web/10b-reply.png" alt="Claude's reply with a screenshot of the app titled Hello from Claude with orange bubbles, the pushed branch, and a Create PR button" />
    </Frame>

    <Frame>
      <img src="/images/claude-code-web/10-after-change.png" alt="The live simulator showing the app with the Hello from Claude title and orange message bubbles" />
    </Frame>
  </Step>
  ...
  <Step title="Open a pull request">
    ...
    <Frame>
      <img src="/images/claude-code-web/11b-pr-created.png" alt="Session bar showing pull request number 1 for the Claude branch with a CI status indicator" />
    </Frame>

    When the workflow finishes, about two minutes in our run, it comments on the pull request with a preview link:

    <Frame>
      <img src="/images/claude-code-web/11-pr-preview-comment.png" alt="Pull request with the Limrun Preview comment linking to the preview for the commit, and the passing iOS Preview check" />
    </Frame>
    ...
    **Open Preview** runs the build from the pull request on a simulator in the Limrun console. Reviewers need to be members of your Limrun organization to open it.
    ...
    <Frame>
      <img src="/images/claude-code-web/12-preview-page.png" alt="Limrun console preview running the changed app with the Hello from Claude title and orange bubbles" />
    </Frame>
  </Step>
</Steps>
